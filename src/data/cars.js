export const CAR_DEFS = [
  ...
  // ── SS Tier: hypercar class ──
  { id:'apex',      name:'Apex Predator',    color:0xff4500, hex:'#ff4500', tier:'SS', maxSpeed:100, accel:58, price:2500, owned:false },
  { id:'specter',   name:'Specter X9',       color:0x00b4ff, hex:'#00b4ff', tier:'SS', maxSpeed:115, accel:65, price:3800, owned:false },
  { id:'hyperion',  name:'Hyperion',         color:0xffd700, hex:'#ffd700', tier:'SS', maxSpeed:130, accel:72, price:5500, owned:false },
];

export const TIER_BADGE = { SS:'⚡ SS', S:'⭐ S', A:'A', B:'B', C:'C' };
export const TIER_COLOR = { SS:'#ff4500', S:'#f72585', A:'#ffbe0b', B:'#2196f3', C:'#666' };

// Prize wheel segments (8 wedges, 45° each)
export const PRIZE_SEGMENTS = [
  { label:'EPIC CAR!',     shortLabel:'EPIC\nCAR',   type:'car',    tier:'SS', color:'#ff4500' },
